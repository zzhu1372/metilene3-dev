...
DMR.bg <- do.call(rbind.fill, lapply(1:d.bg, function(i) {
  ...
  for (gn in groupNames) {
    cov.groups[[gn]] <-
      as.vector(apply(data[st:end, c(data.methyl[[gn]]) + 1], 1, unlist))
  }
  ...
  if (j <= 600) {
    ...
    if (j %% 2 == 1) {
      for (gn in groupNames.L1A) {
        mean.groups[[gn]] <-
          c(
            rbeta(length(data.methyl[[gn]]), shape.1, shape.2) * shape.ratio + rbeta(length(data.methyl[[gn]]), shape.2, shape.1) *
              (1 - shape.ratio)
          )
      }
      for (gn in groupNames.L1B) {
        mean.groups[[gn]] <-
          c(
            rbeta(length(data.methyl[[gn]]), shape.2, shape.1) * shape.ratio + rbeta(length(data.methyl[[gn]]), shape.1, shape.2) *
              (1 - shape.ratio)
          )
      }
    }
  ...
  if ((j > 600) && (j <= 700)) {
    # one vs others
    gn_cmp = groupNames[((j - 1) / 2) %% length(groupNames) + 1]
    ## down-regulation
    if (j %% 2 == 1) {
      for (gn in groupNames) {
        mean.groups[[gn_cmp]] <-
          c(
            rbeta(length(data.methyl[[gn_cmp]]), shape.1, shape.2) * shape.ratio + rbeta(length(data.methyl[[gn_cmp]]), shape.2, shape.1) *
              (1 - shape.ratio)
          )
        if (gn != gn_cmp) {
          mean.groups[[gn]] <-
    ...
    ## up-regulation
      ...
      for (gn in groupNames) {
        mean.groups[[gn_cmp]] <-
          c(
            rbeta(length(data.methyl[[gn_cmp]]), shape.2, shape.1) * shape.ratio + rbeta(length(data.methyl[[gn_cmp]]), shape.1, shape.2) *
              (1 - shape.ratio)
          )
        if (gn != gn_cmp) {
          mean.groups[[gn]] <-
  ...
  if ((j > 700) && (j <= 850)) {
    ...
    if (j %% 2 == 1) {
      for (gn in groupNames) {
        mean.groups[[gn_cmp1]] <-
          c(
            rbeta(length(data.methyl[[gn_cmp1]]), shape.1, shape.2) * shape.ratio +
              rbeta(length(data.methyl[[gn_cmp1]]), shape.2, shape.1) * (1 - shape.ratio)
          )
        mean.groups[[gn_cmp21]] <-
          c(
            rbeta(length(data.methyl[[gn_cmp21]]), shape.2, shape.1) * shape.ratio +
              rbeta(length(data.methyl[[gn_cmp21]]), shape.1, shape.2) * (1 - shape.ratio)
          )
        mean.groups[[gn_cmp22]] <-
          c(
            rbeta(length(data.methyl[[gn_cmp22]]), shape.2, shape.1) * shape.ratio +
              rbeta(length(data.methyl[[gn_cmp22]]), shape.1, shape.2) * (1 - shape.ratio)
          )
        if ((gn != gn_cmp1) &&
          ...
          if ((j %% 4) / 2 >= 1) {
            mean.groups[[gn]] <-
              c(
                rbeta(length(data.methyl[[gn]]), shape.4, shape.3) * shape.ratio + rbeta(length(data.methyl[[gn]]), shape.3, shape.4) *
                  (1 - shape.ratio)
              )
          } else {
            mean.groups[[gn]] <-
              c(
                rbeta(length(data.methyl[[gn]]), shape.3, shape.4) * shape.ratio + rbeta(length(data.methyl[[gn]]), shape.4, shape.3) *
                  (1 - shape.ratio)
              )
          }
        }
    ...
    ## up-regulation
      ...
      for (gn in groupNames) {
        mean.groups[[gn_cmp1]] <-
          c(
            rbeta(length(data.methyl[[gn_cmp1]]), shape.2, shape.1) * shape.ratio +
              rbeta(length(data.methyl[[gn_cmp1]]), shape.1, shape.2) * (1 - shape.ratio)
          )
        mean.groups[[gn_cmp21]] <-
          c(
            rbeta(length(data.methyl[[gn_cmp21]]), shape.1, shape.2) * shape.ratio +
              rbeta(length(data.methyl[[gn_cmp21]]), shape.2, shape.1) * (1 - shape.ratio)
          )
        mean.groups[[gn_cmp22]] <-
          c(
            rbeta(length(data.methyl[[gn_cmp22]]), shape.1, shape.2) * shape.ratio +
              rbeta(length(data.methyl[[gn_cmp22]]), shape.2, shape.1) * (1 - shape.ratio)
          )
        if ((gn != gn_cmp1) &&
            (gn != gn_cmp21) && (gn != gn_cmp22)) {
          if ((j %% 4) / 2 >= 1) {
  ...
  if ((j > 850) && (j <= 1000)) {
    ...
    if (j %% 2 == 1) {
      for (gn in groupNames) {
        ...
        mean.groups[[gn_cmp2]] <-
          c(
            rbeta(length(data.methyl[[gn_cmp2]]), shape.2, shape.1) * shape.ratio +
              rbeta(length(data.methyl[[gn_cmp2]]), shape.1, shape.2) * (1 - shape.ratio)
          )
    ...
    ## up-regulation
      ...
      for (gn in groupNames) {
        ...
        mean.groups[[gn_cmp2]] <-
          c(
            rbeta(length(data.methyl[[gn_cmp2]]), shape.1, shape.2) * shape.ratio +
              rbeta(length(data.methyl[[gn_cmp2]]), shape.2, shape.1) * (1 - shape.ratio)
          )
        if ((gn != gn_cmp1) && (gn != gn_cmp2)) {
          if ((j %% 4) / 2 >= 1) {
            mean.groups[[gn]] <-
...
for (gn in groupNames) {
  for (i in data.methyl[[gn]]) {
    ...
    write.table(
      ...
      format(sample, scientific = F, trim = T),
      col.names = F,
      row.names = F,
      sep = "\t",
      quote = F
...
# Plot beta distribution on signal
y_beta <-
  rbeta(1000, shape1 = shape.1, shape2 = shape.2) * shape.ratio + rbeta(1000, shape1 = shape.2, shape2 = shape.1) *
  (1 - shape.ratio)
y_beta_r <-
  rbeta(1000, shape1 = shape.2, shape2 = shape.1) * shape.ratio + rbeta(1000, shape1 = shape.1, shape2 = shape.2) *
  (1 - shape.ratio)
p1 <- hist(y_beta)
p2 <- hist(y_beta_r)
jpeg(
  file = paste0(
    "distribution-signal-beta_",
    shape.1,
    "_",
    shape.2,
    "_",
...
# Plot beta distribution on noise
y_beta <-
  rbeta(1000, shape1 = shape.3, shape2 = shape.4) * shape.ratio + rbeta(1000, shape1 = shape.4, shape2 = shape.3) *
  (1 - shape.ratio)
y_beta_r <-
  rbeta(1000, shape1 = shape.4, shape2 = shape.3) * shape.ratio + rbeta(1000, shape1 = shape.3, shape2 = shape.4) *
  (1 - shape.ratio)
p1 <- hist(y_beta)
p2 <- hist(y_beta_r)
jpeg(
  file = paste0(
    "distribution-noise-beta_",
    shape.1,
    "_",
    shape.2,
    "_",
